...
#
"""
File: lstm_replacing.py
Author: shileicao(shileicao@stu.xjtu.edu.cn)
Date: 2017-5-22 19:32:29
"""
...
tf.app.flags.DEFINE_string('train_data_path', "data/train/replacing_train.txt",
                           'Training data dir')
tf.app.flags.DEFINE_string('test_data_path', "data/test/replacing_test.txt",
                           'Test data dir')
tf.app.flags.DEFINE_string('log_dir', "lstm_replacing_logs", 'The log  dir')
...
class Model:
    ...
    def inference(self, clfier_wX, reuse=None, trainMode=True):
